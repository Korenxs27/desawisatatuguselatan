          ...
          <div className="lg:col-span-2 space-y-8">
            ...
            <div className="bg-white/70 backdrop-blur-xl p-8 sm:p-10 rounded-[2.5rem] border border-white/85 shadow-xl shadow-slate-200/50 space-y-6">
              ...
              <div className="border-t border-slate-200/80 pt-6 space-y-4">
                <h3 className="text-sm font-bold text-slate-900 uppercase tracking-wider">Komposisi / Bahan Unggulan:</h3>
            ...
            <div className="bg-white/90 backdrop-blur-2xl border border-slate-200/90 rounded-[2.5rem] p-6 sm:p-8 shadow-2xl sticky top-28 space-y-6">
              ...
              <div className="border-b border-slate-200 pb-4">
                ...
                <div className="flex items-baseline gap-1 mt-1">
                  <span className="text-2xl font-extrabold text-emerald-600">Rp. {product.price.toLocaleString("id-ID")}</span>
                ...
                <div className="space-y-4 animate-fadeIn">
                  ...
                  <div className="space-y-2 text-left">
                    ...
                    <div className="grid grid-cols-1 gap-2">
                      <button onClick={() => handleCompletePayment("QRIS Instant")} className="p-3 rounded-xl border border-slate-200 hover:border-emerald-600 bg-white font-bold text-xs text-slate-800 text-left transition shadow-sm flex items-center justify-between">
                      ...
                      <button onClick={() => handleCompletePayment("Transfer Bank BCA/BRI")} className="p-3 rounded-xl border border-slate-200 hover:border-emerald-600 bg-white font-bold text-xs text-slate-800 text-left transition shadow-sm flex items-center justify-between">
                        <span>🏦 Transfer Bank (BCA / BRI)</span>
                      </button>
                      <button onClick={() => handleCompletePayment("E-Wallet GoPay/OVO")} className="p-3 rounded-xl border border-slate-200 hover:border-emerald-600 bg-white font-bold text-xs text-slate-800 text-left transition shadow-sm flex items-center justify-between">
                        <span>💳 E-Wallet (GoPay / OVO)</span>
                      </button>
                    </div>
                  </div>

                  <button onClick={() => setOrderStep("form")} className="w-full py-2.5 text-xs font-bold text-slate-600 bg-slate-100 hover:bg-slate-200 rounded-xl transition">
              ...
              {orderStep === "success" && (
                <div className="space-y-4 text-center animate-fadeIn py-2">
                  ...
                  <button onClick={() => setOrderStep("form")} className="w-full bg-[#0f172a] hover:bg-emerald-900 text-white py-3 rounded-xl text-xs font-bold shadow-md">
