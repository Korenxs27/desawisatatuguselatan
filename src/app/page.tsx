...
export default function HomePage() {
  ...
  return (
    <div className="relative pb-36 pt-4 overflow-x-hidden">
      
      {/* Background Soft Glow Lights */}
      <div className="absolute top-0 left-1/4 w-[500px] h-[500px] bg-emerald-400/10 rounded-full blur-[120px] pointer-events-none"></div>
      <div className="absolute top-1/2 right-10 w-[450px] h-[450px] bg-teal-300/10 rounded-full blur-[120px] pointer-events-none"></div>
      <div className="absolute bottom-1/4 left-10 w-[400px] h-[400px] bg-green-300/10 rounded-full blur-[120px] pointer-events-none"></div>

      {/* 1. HERO SECTION */}
      <section className="max-w-[1200px] mx-auto px-6 pt-5 pb-24 relative z-10">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
          <div className="space-y-6 text-center md:text-left">
            <h1 className="text-4xl md:text-6xl font-extrabold tracking-tight text-[#0f172a] leading-[1.15]">
            ...
            <p className="text-base text-slate-600 font-normal leading-relaxed max-w-lg mx-auto md:mx-0">
            ...
            <div className="pt-2 flex flex-row items-center gap-4 justify-center md:justify-start">
              <a 
                href="#paket-unggulan" 
                className="bg-[#0f172a] hover:bg-emerald-900 text-white px-7 py-3.5 rounded-full shadow-xl shadow-slate-900/10 inline-flex flex-row items-center gap-2.5 font-medium whitespace-nowrap text-xs md:text-sm transition-all"
              >
          ...
          {/* Hero Bagian Kanan Diubah Menjadi Gambar */}
          <div className="relative p-3 rounded-[2.5rem] bg-white/50 backdrop-blur-2xl border border-white/80 shadow-2xl shadow-emerald-900/5">
            <div className="relative aspect-[16/11] rounded-3xl overflow-hidden shadow-inner">
              <img 
              ...
              <div className="absolute inset-0 bg-gradient-to-t from-slate-950/70 via-transparent to-transparent flex items-end p-6">
                <div className="text-white space-y-1">
                  <span className="text-[10px] bg-emerald-600 font-bold px-3 py-1 rounded-full uppercase tracking-wider">Kawasan Wisata Terpadu</span>
                  <h4 className="text-sm font-bold pt-1">Desa Wisata Asri & Sejuk Puncak</h4>
                </div>
              </div>
            </div>
          </div>
      ...
      <section id="paket-unggulan" className="max-w-[1200px] mx-auto px-6 py-20 relative z-10">
        <div className="flex flex-col md:flex-row justify-between items-start md:items-end gap-4 border-b border-slate-200/80 pb-5 mb-12">
          <div>
            <span className="text-xs font-bold text-emerald-600 uppercase tracking-widest flex items-center gap-1.5 mb-1"><Compass size={14}/> Sorotan Petualangan</span>
            <h2 className="text-3xl font-bold tracking-tight text-[#0f172a]">Paket Wisata Unggulan</h2>
          </div>
                ...
                <div className="p-7 flex flex-col justify-between flex-grow space-y-4">
                  ...
                  <div className="flex justify-between items-center pt-4 border-t border-slate-100/80">
                    <div>
                      ...
                      <span className="text-emerald-600 font-bold text-sm">Rp. {item.price.toLocaleString("id-ID")}</span>
                    </div>
                    <span className="bg-slate-900 group-hover:bg-emerald-600 text-white text-xs font-bold px-4 py-2.5 rounded-xl transition flex items-center gap-1 shadow-sm">
                      Lihat Detail & Booking <ArrowUpRight size={14} />
                    </span>
                  </div>
                </div>
              </Link>
      ...
      <section className="max-w-[1200px] mx-auto px-6 py-20 relative z-10">
        <div className="flex flex-col md:flex-row justify-between items-start md:items-end gap-4 border-b border-slate-200/80 pb-5 mb-12">
          <div>
            <span className="text-xs font-bold text-emerald-600 uppercase tracking-widest flex items-center gap-1.5 mb-1"><ShoppingBag size={14}/> Oleh-Oleh Khas Desa</span>
            <h2 className="text-3xl font-bold tracking-tight text-[#0f172a]">Produk UMKM Pilihan Warga</h2>
          </div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-8">
          {umkmList.map((product) => (
            <div key={product.id}>
              <div className="bg-white/80 backdrop-blur-xl border border-slate-200/90 rounded-[2rem] overflow-hidden shadow-sm hover:shadow-2xl hover:-translate-y-1 transition-all duration-300 p-6 flex flex-col justify-between h-full group">
                ...
                <div className="space-y-3">
                  ...
                  <div className="flex justify-between items-center text-xs pt-3 border-t border-slate-100/80">
                    ...
                    <Link href={`/umkm/${product.slug}`} className="bg-slate-900 group-hover:bg-emerald-600 text-white font-bold px-3.5 py-2 rounded-xl transition flex items-center gap-1 text-[11px] shadow-sm">
                      Detail <Tag size={12} />
                    </Link>
                  </div>
                </div>
      ...
      <section className="max-w-[1200px] mx-auto px-6 py-20 relative z-10">
        <div className="flex flex-col md:flex-row justify-between items-start md:items-end gap-4 border-b border-slate-200/80 pb-5 mb-12">
          <div>
            <span className="text-xs font-bold text-emerald-600 uppercase tracking-widest flex items-center gap-1.5 mb-1"><ImageIcon size={14}/> Potret Kegiatan & Suasana</span>
            <h2 className="text-3xl font-bold tracking-tight text-[#0f172a]">Galeri Desa Tugu Selatan</h2>
          </div>
